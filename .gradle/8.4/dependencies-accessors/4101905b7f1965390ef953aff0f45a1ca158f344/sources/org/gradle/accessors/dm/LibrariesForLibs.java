...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.api
         */
    ...
    public static class GoogleApiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at google.api.client
         */
        ...
        /**
         * Returns the group of libraries at google.api.services
         */
    ...
    public static class GoogleApiClientLibraryAccessors extends SubDependencyFactory {
        ...
        public GoogleApiClientLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for android (com.google.api-client:google-api-client-android)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class GoogleApiServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public GoogleApiServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for drive (com.google.apis:google-api-services-drive)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
        private final PlayBillingLibraryAccessors laccForPlayBillingLibraryAccessors = new PlayBillingLibraryAccessors(owner);
        private final PlayServicesLibraryAccessors laccForPlayServicesLibraryAccessors = new PlayServicesLibraryAccessors(owner);

        public PlayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at play.billing
         */
        public PlayBillingLibraryAccessors getBilling() {
            return laccForPlayBillingLibraryAccessors;
        }
    ...
    public static class PlayBillingLibraryAccessors extends SubDependencyFactory {

        public PlayBillingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("play.billing.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: accompanistPermissions (0.34.0)
            ...
            /**
             * Returns the version associated to this alias: googleApiClient (1.23.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: googleApiServicesDrive (v3-rev20220815-2.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kotlinSerialization (1.9.22)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: playBilling (6.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
